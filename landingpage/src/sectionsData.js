export const sectionsData = [
    ...
    },
    {
        ...
        content: `
            ...
            <p>Pomagam w radzeniu sobie z zaburzeniami lękowymi, takimi jak lęk, fobie, ataki paniki i zaburzenia obsesyjno-kompulsyjne. Wspieram leczenie objawów depresji, w tym uczucia smutku, beznadziei i utraty zainteresowania codziennymi aktywnościami. Pomagam w zarządzaniu zmianami nastroju oraz pracuję nad zrozumieniem i zmianą destrukcyjnych wzorców myślenia i zachowania.</p>
            <p>Uczę technik radzenia sobie ze stresem i przeciążeniem, a także pomagam w rozpoznawaniu i kontrolowaniu agresywnych reakcji. Wspieram osoby w radzeniu sobie z traumą i jej skutkami. Pomagam w nawiązywaniu i utrzymywaniu zdrowych relacji z innymi ludźmi, wspieram w adaptacji do nowych okoliczności życiowych, takich jak zmiana pracy, rozwód czy przeprowadzka, oraz oferuję wsparcie w trudnych sytuacjach, takich jak choroba, wypadki czy inne nagłe zdarzenia.</p>
            <p>Pomagam w osiąganiu celów osobistych, zawodowych i edukacyjnych, pracuję nad lepszym zrozumieniem siebie, swoich motywacji i zachowań oraz wspieram rozwój poczucia własnej wartości i pewności siebie.</p>
        `
    },
    {
